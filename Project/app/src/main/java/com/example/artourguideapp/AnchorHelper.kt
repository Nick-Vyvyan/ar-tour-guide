...
/**
 * This object class contains the functions used to create, update, and remove anchors in
 * the AR Scene.
 */
object AnchorHelper {
    ...
    * */
    fun setAnchors(arSceneView: ArSceneView, entities: MutableList<Entity>) {
        ...
        if (earth?.trackingState == TrackingState.TRACKING) {
            ...
            if (horizontalAccuracy > ApplicationSettings.ACCURACY_MAX_THRESHOLD || verticalAccuracy > ApplicationSettings.ACCURACY_MAX_THRESHOLD) {
            ...
            for (entity in entities) {
                ...
                if (distance > ApplicationSettings.ANCHOR_PROXIMITY_DISTANCE && !entity.isDestination()) {
                    removeAnchor(entity)
                }
