...
describe("webparsing", () => {
  it("returns correct data for Arntzen Hall", () => {
    const data = fs.readFileSync(
      "./test/unit/webscrapingTestAssets/AHTest.html",
      "utf8"
    );
  ...
  it("returns correct data for Bond Hall", () => {
    const data = fs.readFileSync(
      "./test/unit/webscrapingTestAssets/BHTest.html",
      "utf8"
    );
    const returnedData = parseWeb(data);
    const expectedData = {
  ...
  it("returns correct data for Performing Arts Center", () => {
    const data = fs.readFileSync(
      "./test/unit/webscrapingTestAssets/PATest.html",
      "utf8"
    );
    const returnedData = parseWeb(data);
    const expectedData = {
      ...
      accessibilityInfo: `Accessible parking on the southwest side of the building, Accessible entrances, Accessible rest rooms`,
    };
    expect(returnedData).to.deep.equal(expectedData);
  });
  ...
  it("returns correct data for Ridgeway Delta", () => {
    const data = fs.readFileSync(
      "./test/unit/webscrapingTestAssets/RDTest.html",
      "utf8"
    );
    const returnedData = parseWeb(data);
    const expectedData = {
      ...
      accessibilityInfo: `This building is not wheelchair accessible., Accessible parking to west (Lot 15R).`,
    };
    expect(returnedData).to.deep.equal(expectedData);
  });
  ...
  it("returns correct data for Viking Union", () => {
    const data = fs.readFileSync(
      "./test/unit/webscrapingTestAssets/VUTest.html",
      "utf8"
    );
    const returnedData = parseWeb(data);
    const expectedData = {
      ...
      accessibilityInfo: `Automatic doors at High St. and the VU Plaza on the 6th floor and on the 1st floor at the Garden St. entrance., Accessible restrooms on floors 3, 4, 5 and 6., Accessible parking on the north side of the building (Lot 6V).`,
    };
    expect(returnedData).to.deep.equal(expectedData);
  });
  ...
  it("returns correct data for Split Stone", () => {
    const data = fs.readFileSync(
      "./test/unit/webscrapingTestAssets/SSTest.html",
      "utf8"
    );
    const returnedData = parseWeb(data);
    const expectedData = {
  ...
  it("returns correct data for For Handel", () => {
    const data = fs.readFileSync(
      "./test/unit/webscrapingTestAssets/FHTest.html",
      "utf8"
    );
    const returnedData = parseWeb(data);
    const expectedData = {
